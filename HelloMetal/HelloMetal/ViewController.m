...
@property (nonatomic) TriangleRenderer *triangleRenderer;
...
- (void)viewDidLoad {
    ...
    self.triangleRenderer = [[TriangleRenderer alloc] initWithLayer: self.myMetalView.metalLayer andContext: _metalContext];
    [self.triangleRenderer draw];
