                          ...
                          uint iid [[instance_id]])
{
    ...
    {
        case 0:
            outVertex.position = float4(pa.x,pa.y,0,1);
            break;
        case 1:
            outVertex.position = float4(pb.x,pb.y,0,1);
            break;
        case 2:
            outVertex.position = float4(pc.x,pc.y,0,1);
            break;
        case 3:
            outVertex.position = float4(pa.x,pa.y,0,1);
            break;
        case 4:
            ...
            break;
        case 5:
            outVertex.position = float4(pd.x,pd.y,0,1);
            break;
    }
